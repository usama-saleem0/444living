<template>
    ...
    <div class="page-1">
     ...
     <div class="contanir" >
        ...
        <div class="box-1">
            <div class="toppadds">
                <span class="overviews" style="opacity:0">
    ...
    align-items: center;">
                <input type="text" placeholder="Search" class="inputclass" v-model="form.posttitle"/>
 ...
 import Tables from "../admin/usertable.vue"

 import Profile from "./adminprofilecard.vue";
