<template>
    ...
    width: 100%;">
        <svg height="208px" width="208px" viewBox="0 0 128 128" class="loader" style="color: #DED4A2;">
    <defs>
      ...
      <linearGradient y2="1" x2="0" y1="0" x1="0" id="loader-grad">
        <stop stop-color="#DED4A2" offset="0%"></stop>
        <stop stop-color="#DED4A2" offset="100%"></stop>
      </linearGradient>
      <mask id="loader-mask">
    ...
    <g stroke-dasharray="175.93 351.86" stroke-width="12" stroke-linecap="round">
      <g>
        <rect clip-path="url(#loader-eyes)" height="64" width="128" fill="#DED4A2"></rect>
        <g stroke="#DED4A2" fill="none">
