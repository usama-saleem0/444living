...
<div class="main-div">
 <div class="main-box">
    ...
    <div class="main-form">
        ...
        :src="selectedImage ? selectedImage : '/uploads/' + form.image"
         alt=""/>
        <!-- <img src="/images/tabler_edit.png" alt="" style="position: relative;
    z-index: 1;"/> -->
   
      <input type="file" @change="handleFileChange" ref="fileInput" style="display: none" />
      <img
        src="/images/tabler_edit.png"
        alt=""
        ...
        <div class="form-col-2">
            <div class="input-box">
                <div class="input-group">
                    ...
                    <input type="text" placeholder="@alex" v-model="form.user_name">
                </div>
                <div class="input-group">
                    <label for="text">Edit Email</label>
                    <input type="text" placeholder="Alex@someone.com" v-model="form.email">
                </div>
                <div class="input-group-1">
                    <label for="text">Edit Bio</label>
                ...
                <!-- <div class="input-group-3">
                    <label for="text">Edit Email</label>
                    <input class="hello-1"  type="text" placeholder="">
                    <input class="hello-2" type="text" placeholder="">
                    <input class="hello-3" type="text" placeholder="">
                </div> -->
                <div class="input-3">
                        <label for="text">Provide Social Media Handles</label>
                        <input class="icon-input1" style="color: #141c2b;" type="text" placeholder="First Name" v-model="form.firstname">
                        <input class="icon-input2" style="color: #141c2b;" type="text" placeholder="Last Name" v-model="form.lastname">
                        <input class="icon-input3" style="color: #141c2b;" type="number" placeholder="Number" v-model="form.number">
                    </div>
            ...
            <div class="buttons" >
                        <button class="Hire" style="background-color: rgb(20 28 43); color: white;" @click="save">Edit Profile<svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 13 13" fill="none" >
...
export default {
    ...
    // formData.append('facebook', this.form.firstname);
    // formData.append('instagram', this.form.lastname);
    // formData.append('linkdin', this.form.email);
    // formData.append('username', this.form.user_name);


                byMethod(this.method, '/editprofile' , this.form)
                     .then((res) => {
